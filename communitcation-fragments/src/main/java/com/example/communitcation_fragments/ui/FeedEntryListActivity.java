 ...
 * lead to a {@link FeedEntryDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * https://developer.android.com/topic/libraries/architecture/viewmodel.html
 */
public class FeedEntryListActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_feedentry_list);
  ...
  public class SimpleItemRecyclerViewAdapter
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View view = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.feedentry_list_content, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
      ...
      holder.mView.setOnClickListener(v -> {
        ...
        if (mTwoPane) {
          ...
          arguments.putString(FeedEntryDetailFragment.ARG_ITEM_ID, holder.mItem.id);
          FeedEntryDetailFragment fragment = new FeedEntryDetailFragment();
          ...
          Intent intent = new Intent(context, FeedEntryDetailActivity.class);
          intent.putExtra(FeedEntryDetailFragment.ARG_ITEM_ID, holder.mItem.id);
