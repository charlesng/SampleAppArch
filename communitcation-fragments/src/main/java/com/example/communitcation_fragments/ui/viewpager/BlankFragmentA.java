package com.example.communitcation_fragments.ui.viewpager;
...
import com.example.communitcation_fragments.viewmodel.viewpager.PagerAgentViewModel;
...
public class BlankFragmentA extends LifecycleFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(
            v -> ViewModelProviders.of(getActivity()).get(PagerAgentViewModel.class).sendMessageToB("Hello B"));
        return view;
    }
