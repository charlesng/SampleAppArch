 ...
 * in a {@link FeedEntryListActivity}.
 */
public class FeedEntryDetailActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_feedentry_detail);
    ...
    if (savedInstanceState == null) {
      ...
      arguments.putString(FeedEntryDetailFragment.ARG_ITEM_ID,
          getIntent().getStringExtra(FeedEntryDetailFragment.ARG_ITEM_ID));
      ...
      masterDetailShareViewModel.selectFeedEntry(getIntent().getStringExtra(FeedEntryDetailFragment.ARG_ITEM_ID));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == android.R.id.home) {
      ...
      //
      NavUtils.navigateUpTo(this, new Intent(this, FeedEntryListActivity.class));
      return true;
    }
