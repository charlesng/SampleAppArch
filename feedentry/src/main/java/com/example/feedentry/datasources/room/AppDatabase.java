...
@Database(entities = {FeedEntry.class}, version = 2)
public abstract class AppDatabase extends RoomDatabase {
  ...
  public static AppDatabase getDb(Context context) {
    return Room.databaseBuilder(context, AppDatabase.class, "feedentry-db").addMigrations(
        Migration1_2.newInstance()).build();
  }
}
